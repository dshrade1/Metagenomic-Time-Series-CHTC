...
samtools merge $1.bam /mnt/gluster/dgshrader/TH_bam/$1/*
...
htseq-count -f sam -r name -s no -a 0 -t CDS -i locus_tag -m intersection-strict sorted_$1.sam /mnt/gluster/dgshrader/3300000553.gff > CDS_$1.count
htseq-count -f sam -r name -s no -a 0 -t tRNA -i locus_tag -m intersection-strict sorted_$1.sam /mnt/gluster/dgshrader/3300000553.gff > tRNA_$1.count
htseq-count -f sam -r name -s no -a 0 -t rRNA -i locus_tag -m intersection-strict sorted_$1.sam /mnt/gluster/dgshrader/3300000553.gff > rRNA_$1.count
htseq-count -f sam -r name -s no -a 0 -t repeat_region -i locus_tag -m intersection-strict sorted_$1.sam /mnt/gluster/dgshrader/3300000553.gff > rr_$1.count
